require.config({
    ...
    paths: {
		...
		'dataTables-responsive': "components/datatables/dist/media/js/dataTables.responsive",
		'dataTables-bootstrap': "components/datatables/dist/media/js/dataTables.bootstrap",
